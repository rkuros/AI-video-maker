...
void main() {
  testWidgets('Cmd+Z undoes last timeline edit', (tester) async {
    ...
    // Delete the selected clip (this is an undoable edit).
    await tester.sendKeyEvent(LogicalKeyboardKey.delete);
    await tester.pump();
    expect(container.read(timelineProvider).videoTracks.first.clips, isEmpty);

    // Cmd+Z should restore it.
    ...
    final restored = container.read(timelineProvider);
    expect(restored.videoTracks.first.clips, hasLength(1));
